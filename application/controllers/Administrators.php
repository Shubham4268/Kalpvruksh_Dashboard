...
class Administrators extends CI_Controller
{
  ...
  public function laad_()
  {
    ...
    $totalAdministrators = ($admins = $this->admin->getAll()) ? count($admins) : 0;
    ...
    $json['adminList'] = $this->load->view('admin/adminlist', $data, TRUE); //get view with populated customers table
