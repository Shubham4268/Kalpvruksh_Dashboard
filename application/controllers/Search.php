  ...
  public function itemSearch()
{
    ...
    $json['itemsListTable'] = $data['allItems']
        ? $this->load->view('items/itemslisttable', $data, TRUE)
        : "<tr><td colspan='8'>No match found</td></tr>";
  ...
  */
  ...
  public function manufacturerSearch()
  {
    ...
    $data['allManufacturers'] = $this->Manufacturer_model->search($this->value);
    $data['sn'] = 1;

    $json['manufacturerListTable'] = $data['allManufacturers']
      ? $this->load->view('manufacturer/manufacturertable', $data, TRUE)
      : "<ul><li>No match found</li></ul>";
  ...
  public function categorySearch()
  {
    ...
    $value = $this->input->get('v', TRUE);

    $data['categories'] = $this->Category_Model->search($value);
    $data['sn'] = 1;

    $json['categoryListTable'] = $data['categories']
      ? $this->load->view('category/categorytable', $data, TRUE)
      : "<ul><li>No match found</li></ul>";
