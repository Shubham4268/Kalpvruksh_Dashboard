...
class Transaction extends CI_Model
{
    ...
    public function getUserTransactions($phone)
    {
        $this->db->where('cust_phone', $phone);
        $query = $this->db->get('transactions'); // Replace with your actual table name
        return $query->result();
    }
    public function countUserTransactions($phone)
    {
        $this->db->where('cust_phone', $phone);
        return $this->db->count_all_results('transactions');
    }
    public function getUserTransactionsPaginated($phone, $orderBy, $orderFormat, $start, $limit)
    {
        $this->db->where('cust_phone', $phone);
        $this->db->order_by($orderBy, $orderFormat);
        $this->db->limit($limit, $start);
