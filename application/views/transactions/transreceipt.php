...
<div id="transReceiptToPrint">
    <div class="row">
        <div class="col-xs-12 text-center text-uppercase">
            <center style='margin-bottom:5px'><img src="<?=base_url()?>public/images/logo_white.png" alt="logo" class="img-responsive" width="60px"></center>
            <b>Gandhi Peth, Chinchwad Gaon, Chinchwad</b>
            <div>+919552953336</div>
        </div>
    </div>
