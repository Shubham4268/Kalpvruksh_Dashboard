            ...
            <div class="row">
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' id='showTransForm'><i class="fa fa-plus"></i> New Invoice </button>
                    </span>
                </div>
                <div class="col-sm-3">
                    <span class="pointer text-primary">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-4 form-inline form-group-sm">
                        ...
                        <input type="search" id="transSearch" class="form-control" placeholder="Search Invoices">
                    </div>
                </div>
            </div>
