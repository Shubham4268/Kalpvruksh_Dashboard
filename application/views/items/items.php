                ...
                <div class="well">
                    ...
                    <form name="addNewItemForm" id="addNewItemForm" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group-sm">
                                <label for="itemMnf">Manufacturer</label>
                                <select id="itemMnf" name="itemMnf" class="form-control">
                                    <option value="">Select Manufacturer</option>
                                    <?php foreach ($manufacturers as $mnf): ?>
                                        <option value="<?= $mnf->id ?>"><?= $mnf->mnf_name ?> (ID: <?= $mnf->id ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                                <span class="help-block errMsg" id="itemMnfErr"></span>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                <form role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group-sm">
                            <label for="itemMnfEdit">Manufacturer</label>
